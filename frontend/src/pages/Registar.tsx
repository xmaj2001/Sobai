      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 bg-gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-primary-foreground max-w-lg">
          ...
          <p className="text-lg text-primary-foreground/80">
            Mais de 50.000 utilizadores já descobriram uma nova forma de aprender. 
            Crie a sua conta gratuita e comece hoje.
          </p>
          
          <div className="mt-12 grid grid-cols-3 gap-4 text-center">
            <div>
              <p className="text-3xl font-bold">10K+</p>
              <p className="text-sm text-primary-foreground/70">Livros</p>
            </div>
            <div>
              <p className="text-3xl font-bold">1M+</p>
              <p className="text-sm text-primary-foreground/70">Resumos</p>
            </div>
            <div>
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Preencha os dados abaixo para criar a sua conta gratuita.
            </p>
          </div>
